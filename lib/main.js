...
module.exports.start = async () => {
    ...
    if (config.localRepoPath != undefined) {
        ...
        var branchRun = await github.getLastRunFromBranchAndHash(local.branch, local.hash)
        var branchName = local.branch
        ...
        await submenus(output, github, `:: My Branch :: ${branchName}`, branchRun)
